import{r as l,j as e,E as oe,y as ne,a as ie,b as le,d as de,t as M,D as ce,H as me}from"./index-BoSYs26C.js";import ue from"./EmployeeCredentialsSection-BAz0dpvJ.js";import"./GtaCallback-vJ5BfubJ.js";(function(){try{var n=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};n.SENTRY_RELEASE={id:"81805a56c7001bf4d3706a75085ffa96b066af40"};var w=new n.Error().stack;w&&(n._sentryDebugIds=n._sentryDebugIds||{},n._sentryDebugIds[w]="0a5522f4-6050-451b-bd73-4b59a6a5702f",n._sentryDebugIdIdentifier="sentry-dbid-0a5522f4-6050-451b-bd73-4b59a6a5702f")}catch{}})();const he=({show:n,onClose:w,record:o,darkMode:I})=>{const[h,T]=l.useState(!1);if(!n||!o)return null;const A=o.bullets?Array.isArray(o.bullets)?o.bullets:[o.bullets]:[],t=()=>{const i=oe(o);navigator.clipboard.writeText(i).then(()=>{T(!0),setTimeout(()=>T(!1),2e3)})};return e.jsxs("div",{className:"autopsy-modal-overlay","data-theme":I?"dark":"light",onClick:w,children:[e.jsxs("div",{className:"autopsy-modal-content",onClick:i=>i.stopPropagation(),children:[e.jsx("span",{className:"autopsy-modal-close",onClick:w,children:"×"}),e.jsxs("div",{className:"d-flex justify-content-between align-items-start",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"autopsy-modal-title",children:["Morgue Intake Records for ",o.name]}),e.jsxs("p",{className:"autopsy-modal-subtitle",children:["CASE #",o.caseId]})]}),e.jsxs("button",{className:`autopsy-copy-btn ${h?"copied":""}`,onClick:t,title:"Copy BBCode for Forums",children:[e.jsx("i",{className:`fas ${h?"fa-check":"fa-copy"} me-2`}),h?"Copied!":"Copy BBCode"]})]}),e.jsxs("div",{className:"autopsy-warning-banner",children:[e.jsx("i",{className:"fas fa-exclamation-triangle me-2"}),e.jsx("strong",{children:"NOTICE:"})," Law Enforcement MAY use the PHMC Morgue Intake Records for PKs as proof of deaths for court cases. CKs will require a formal autopsy process which can be requested on the PHMC Forums."]}),o.adminNote&&e.jsxs("div",{className:"autopsy-admin-note-section",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-sticky-note me-2"}),"Admin Notes / Injuries"]}),e.jsx("p",{children:o.adminNote})]}),e.jsx("hr",{className:"autopsy-modal-hr"}),e.jsxs("div",{className:"autopsy-data-grid",children:[e.jsxs("div",{className:"autopsy-data-section",children:[e.jsx("h4",{children:"Vital Statistics"}),e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"Estimated Age"}),e.jsx("span",{children:o.estimatedAge})]}),e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"Physical Description"}),e.jsx("div",{className:"autopsy-text-block",children:o.physicalDescription})]}),e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"Identifying Marks / Tattoos"}),e.jsx("span",{children:o.tattoos})]})]}),e.jsxs("div",{className:"autopsy-data-section",children:[e.jsx("h4",{children:"Discovery Details"}),e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"Time of Death"}),e.jsx("span",{children:o.timeOfDeath})]}),e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"Location of Discovery"}),e.jsx("span",{children:o.location})]}),e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"Cause of Death"}),e.jsx("span",{style:{color:"var(--modal-danger)",fontWeight:"bold"},children:o.causeOfDeath})]}),e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"DNA Profile"}),e.jsx("span",{className:"font-monospace small",children:o.dnaProfile})]})]}),e.jsxs("div",{className:"autopsy-data-section",style:{gridColumn:"span 2"},children:[e.jsx("h4",{children:"Forensic Collection & Toxicology"}),e.jsxs("div",{className:"ooc-disclaimer-warning",children:[e.jsx("i",{className:"fas fa-exclamation-triangle me-1"}),e.jsx("strong",{children:"OOC Information:"})," The data below (slugs, exact injuries, narcotics) is strictly Out of Character. Any use of this information In Character requires a formal autopsy request."]}),e.jsxs("div",{className:"ooc-disclaimer-note",children:[e.jsx("i",{className:"fas fa-flask me-1"}),e.jsx("strong",{children:"Law Enforcement Note:"})," Slugs and Alcohol readings are visual reference for Medical Examiners performing autopsies. If you require the slugs IC'ly on the PHMC Forums here -                             ",e.jsx("a",{href:"https://phmc.gta.world/viewforum.php?f=265",target:"_blank",rel:"noopener noreferrer",className:"autopsy-request-link",children:"Link To Autopsy"})]}),e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"Alcohol / Narcotics Screen"}),e.jsxs("span",{style:{color:o.bac!=="0.00%"||o.narcotics&&o.narcotics!=="None"?"var(--modal-danger)":"var(--modal-success)",fontWeight:"bold"},children:["BAC: ",o.bac," | Narcotics: ",o.narcotics]})]}),A.length>0&&e.jsxs("div",{className:"autopsy-field",children:[e.jsx("span",{className:"autopsy-label",children:"Evidence Collected (Bullets)"}),e.jsx("div",{children:A.map((i,f)=>e.jsxs("div",{className:"small",children:["• ",i.type]},f))})]}),o.findings&&o.findings.length>0&&e.jsxs("div",{className:"autopsy-field mt-3",children:[e.jsx("span",{className:"autopsy-label",children:"Autopsy Findings"}),e.jsx("div",{className:"table-responsive",children:e.jsxs("table",{className:"autopsy-findings-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Time"}),e.jsx("th",{children:"Wound Type"}),e.jsx("th",{children:"Body Part"}),e.jsx("th",{children:"Dist."})]})}),e.jsx("tbody",{children:o.findings.map((i,f)=>e.jsxs("tr",{children:[e.jsx("td",{children:i.time}),e.jsx("td",{children:i.type}),e.jsx("td",{children:i.part}),e.jsx("td",{children:i.dist})]},f))})]})})]})]})]})]}),e.jsx("style",{children:`
            ...
            `})]})},ve=()=>{const{morgueRecords:n,factionsData:w,isLoadingData:o,loadMorgueRecords:I}=ne(),{isPhmcMember:h,user:T,logout:A}=ie(),{user:t,isAuthenticated:i}=le(),{showNotification:f}=de(),[W,q]=l.useState(""),[k,O]=l.useState(""),[Y,G]=l.useState(null),[V,F]=l.useState(!1),[be,ge]=l.useState(!1),[u,U]=l.useState(null),[z,Q]=l.useState(!1),m=window.location.hostname==="localhost",[j,E]=l.useState(1),R=15,[$,_]=l.useState(!1),[J,X]=l.useState(localStorage.getItem("morgue_welcome_dismissed")==="true"),[C,Z]=l.useState(()=>{const a=localStorage.getItem("morgue_dark_mode");return a!==null?a==="true":!0}),p=l.useMemo(()=>{if(!i||!t)return m&&u?{name:"Dev User",dept:u==="employee"?"PHMC Staff":"Authorized Personnel"}:null;const a=t?.allFactionCharacters?.[0],r=a?.character?.characterName||a?.characterName||t.username,d=t?.character||t?.characters,s=d&&d.length>0?d[0].characterName||`${d[0].firstname} ${d[0].lastname}`.trim()||d[0].name:null;return{name:t.faction?.characterName||t.activeCharacter?.characterName||r||s||t.username,dept:t.faction?.rank||(h?"PHMC Employee":"Authorized Personnel")}},[h,t,i,m,u]),c=l.useMemo(()=>m?u!=="denied":i,[i,u,m]);l.useMemo(()=>m&&u==="employee"?!0:h,[h,u,m]);const L=l.useMemo(()=>{if(!c||!n||n.length===0)return null;const a=Math.max(...n.map(x=>x.lastUpdated||0));if(!a)return null;const r=Date.now(),d=1440*60*1e3,s=a+d,v=Math.max(0,Math.ceil((s-r)/(1e3*60*60)));return{last:new Date(a).toLocaleString([],{dateStyle:"short",timeStyle:"short"}),next:v>0?`${v}h`:"Soon",isOverdue:r>s}},[n,c]),S=l.useMemo(()=>!c||!n?[]:[...n].sort((r,d)=>{const s=Number(r.caseId)||0;return(Number(d.caseId)||0)-s}).filter(r=>((r.name||"").toLowerCase().includes(k.toLowerCase())||String(r.caseId||"").toLowerCase().includes(k.toLowerCase())||(r.location||"").toLowerCase().includes(k.toLowerCase()))&&(!z||(r.causeOfDeath||"").includes("((CK))"))),[n,k,c,z]),H=j*R,ee=H-R,B=S.slice(ee,H),P=Math.ceil(S.length/R),ae=a=>{const d=(()=>{try{const b=localStorage.getItem("gta-user-data");if(b){const y=JSON.parse(b),g=y?.character||y?.characters,re=g&&g.length>0?g[0].characterName||`${g[0].firstname} ${g[0].lastname}`.trim()||g[0].name:null;return{username:y?.username,characterName:y?.faction?.characterName||y?.activeCharacter?.characterName||re}}}catch{}return{username:null,characterName:null}})(),s=t?.username||d.username||"Unknown OAuth",x=(()=>{if(t?.faction?.characterName)return t.faction.characterName;if(t?.activeCharacter?.characterName)return t.activeCharacter.characterName;const b=t?.allFactionCharacters?.[0];if(b)return b.character?.characterName||b.characterName;const y=t?.character||t?.characters;if(y&&y.length>0){const g=y[0];return g.characterName||`${g.firstname} ${g.lastname}`.trim()||g.name}return d.characterName})()||"Unknown Character",D=new Date().toLocaleString();if(!m&&s==="Unknown OAuth"&&x==="Unknown Character"){f("Session not fully loaded. Please refresh and try again.","warning");return}console.log(`[Audit] [${m?"Local Dev":"Production"}] USER - ${s} - ${x} has accessed CASE #${a.caseId} - ${a.name} at ${D}`);const N={embeds:[{title:"Morgue Record Accessed",color:3447003,description:`**${x}** ((${s})) is viewing a detailed autopsy report.`,fields:[{name:"Environment",value:m?"🔧 Local Dev":"🌐 Production",inline:!0},{name:"Case Number",value:String(a.caseId),inline:!0},{name:"Decedent Name",value:a.name,inline:!0},{name:"Time of Death",value:a.timeOfDeath||"Unknown",inline:!0},{name:"Access Time",value:D,inline:!1}],footer:{text:"PHMC Morgue Access Audit"}}]};M("admin",N).catch(b=>console.error("Failed to send access audit:",b)),G(a),F(!0)},K=a=>{E(a),document.querySelector(".morgue-table-container")?.scrollTo(0,0)};l.useEffect(()=>{const a=r=>{if(r.ctrlKey&&r.altKey&&r.key.toLowerCase()==="d"){const d=!$;if(_(d),d){console.log("[MorgueLookup] Diagnostics Enabled");const s=t?.character||t?.characters,v=s&&s.length>0?s[0].characterName||`${s[0].firstname} ${s[0].lastname}`.trim()||s[0].name:null,x=s&&s.length>0?s[0].id:null,D=t?.faction?.characterId||t?.activeCharacter?.characterId||t?.faction?.id||x,N=t?.faction?.characterName||t?.activeCharacter?.characterName||v;me(`Morgue Access Diagnostic: ${N||"Unknown"} (${t?.username||"No User"})`,{level:"info",tags:{component:"MorgueLookup",access_status:c?"granted":"denied",is_phmc:h},extra:{identity:{charId:D,charName:N,username:t?.username,isAuthenticated:i},access_logic:{hasAccess:c,isPhmcMember:h,devAccessOverride:u,isLocalHost:m},database:{recordsCount:n?.length||0,filteredCount:S?.length||0},timestamp:new Date().toISOString()}})}}};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[$,i,t,c,h]),l.useEffect(()=>{if(c&&i&&t){const a=t?.character||t?.characters,r=a&&a.length>0?a[0].characterName||`${a[0].firstname} ${a[0].lastname}`.trim()||a[0].name:null,d=a&&a.length>0?a[0].id:null,s=t.faction?.characterId||t.activeCharacter?.characterId||t.faction?.id||d,v=t.faction?.characterName||t.activeCharacter?.characterName||r;if(!s||!v){console.log("[MorgueLookup] Access granted but character data not yet resolved. Deferring audit log...");return}const x=`morgue_access_notified_${s}`;if(!sessionStorage.getItem(x)){const N={embeds:[{title:"Morgue Lookup Access: GRANTED",color:3066993,fields:[{name:"Username",value:t.username||"Unknown",inline:!0},{name:"Character",value:v,inline:!0},{name:"Character ID",value:String(s),inline:!0},{name:"Timestamp",value:new Date().toLocaleString(),inline:!1}],footer:{text:"PHMC Morgue Security Audit"}}]};M("admin",N).catch(b=>console.error("Failed to send morgue access notification:",b)),sessionStorage.setItem(x,"true")}}},[c,i,t]),l.useEffect(()=>{c&&I()},[c,I]);const te=l.useCallback(async()=>{const a={content:`<@228306972204597248> user: ${t?.username||"Unknown"}, character: ${p?.name||"Unknown User"} is requesting a morgue update. Total records: ${n?.length||0}`,embeds:[{title:"Morgue Update Requested",color:15105570,description:`**${p?.name||"Unknown User"}** (${t?.username||"Unknown"}) is requesting a manual update of morgue records.`,fields:[{name:"Environment",value:m?"🔧 Local Dev":"🌐 Production",inline:!0},{name:"Total Records",value:String(n?.length||0),inline:!0},{name:"Request Time",value:new Date().toLocaleString(),inline:!1}],footer:{text:"PHMC Morgue Update Request"}}]};try{await M("admin",a),f("Request sent - You may be contacted via Discord to keep you updated. If you require a specific entry please contact Fr0styDev on Discord, or PHMC Lobby","success")}catch{f("Failed to send update request. Try again later.","error")}},[p,t,m,n,f]),se=()=>{Z(a=>{const r=!a;return localStorage.setItem("morgue_dark_mode",String(r)),r})};return e.jsxs("div",{className:`morgue-lookup-page ${C?"dark-theme":"light-theme"}`,children:[e.jsx(ce,{}),e.jsxs("aside",{className:"morgue-sidebar",children:[e.jsx("div",{className:"morgue-sidebar-header",children:"Morgue Intake System"}),p&&e.jsx("div",{className:"morgue-user-welcome mb-4 p-3 rounded bg-dark bg-opacity-25 border border-secondary border-opacity-50",children:e.jsxs("div",{className:"d-flex justify-content-between align-items-start",children:[e.jsxs("div",{children:[e.jsx("div",{className:"small opacity-75 text-uppercase fw-bold mb-1",style:{fontSize:"0.65rem",letterSpacing:"1px",color:"#3498db"},children:"Welcome Back"}),e.jsx("div",{className:"fw-bold text-white mb-1",style:{fontSize:"1.05rem"},children:p.name}),e.jsx("div",{className:"small opacity-75",style:{fontSize:"0.8rem",fontStyle:"italic"},children:p.dept})]}),e.jsxs("button",{onClick:()=>{A(),window.location.href="/"},className:"btn btn-outline-light btn-sm",title:"Log out",style:{fontSize:"0.75rem",padding:"3px 10px"},children:[e.jsx("i",{className:"fas fa-sign-out-alt me-1"}),"Logout"]})]})}),e.jsxs("div",{className:"morgue-search-box",children:[e.jsx("label",{htmlFor:"decedentSearch",children:"DECEDENT LOOKUP"}),e.jsx("input",{type:"text",id:"decedentSearch",placeholder:"Enter name, case #...",value:W,disabled:!c,onChange:a=>q(a.target.value),onKeyDown:a=>{if(a.key==="Enter"){const r=a.target.value.trim(),d=r?(n||[]).filter(s=>(s.name||"").toLowerCase().includes(r.toLowerCase())||String(s.caseId||"").toLowerCase().includes(r.toLowerCase())||(s.location||"").toLowerCase().includes(r.toLowerCase())).length:(n||[]).length;O(r),E(1),M("admin",{embeds:[{title:"Morgue Search",color:3447003,description:`**${p?.name||"Unknown"}** searched the Morgue database.`,fields:[{name:"Search Term",value:`\`${r||"(none - showing all)"}\``,inline:!0},{name:"Results",value:String(d),inline:!0},{name:"Username",value:t?.username||"Unknown",inline:!0}],timestamp:new Date().toISOString(),footer:{text:"PHMC Morgue Usage Analytics"}}]}).catch(s=>{console.error("[MorgueLookup] Search webhook failed:",s),M("admin",{embeds:[{title:"⚠️ Morgue Search Webhook Failed",color:16761095,description:`**User:** ${p?.name||"Unknown"}
**Search:** \`${r||"(none)"}\`
**Error:** ${s.message||"Unknown"}`,timestamp:new Date().toISOString()}]}).catch(()=>{})})}}}),e.jsxs("div",{className:"morgue-search-hint",children:["Press Enter to search. You can search by name, case number, or location.",k&&e.jsxs("button",{className:"morgue-search-reset",onClick:()=>{O(""),q(""),E(1)},children:[e.jsx("i",{className:"fas fa-times me-1"}),"Clear"]})]})]}),c&&e.jsxs("div",{className:"morgue-sidebar-info mt-4",children:[e.jsx("div",{className:"small text-muted mb-2 text-uppercase fw-bold",children:"Filtered Results"}),e.jsx("div",{className:"display-6 fw-bold",children:S.length})]}),c&&e.jsxs("div",{className:"morgue-sidebar-filter mt-3",children:[e.jsxs("label",{className:"d-flex align-items-center gap-2",style:{cursor:"pointer",userSelect:"none"},children:[e.jsx("input",{type:"checkbox",checked:z,onChange:a=>{Q(a.target.checked),E(1)}}),e.jsxs("span",{className:"small",style:{color:"var(--sidebar-text-muted)"},children:[e.jsx("i",{className:"fas fa-skull me-1"}),"CK deaths only"]})]}),e.jsx("div",{className:"small mt-1",style:{color:"var(--text-muted)",fontSize:"0.65rem",lineHeight:1.3},children:"Relies on Cause of Death field — not an accurate metric"})]}),m&&e.jsxs("div",{className:"morgue-sidebar-dev p-3 border border-warning rounded bg-dark bg-opacity-25",children:[e.jsxs("div",{className:"small text-warning mb-2 text-uppercase fw-bold",children:[e.jsx("i",{className:"fas fa-tools me-2"}),"Dev Access Override"]}),e.jsxs("div",{className:"d-flex flex-column gap-2",children:[e.jsx("button",{className:`btn btn-sm ${u==="employee"?"btn-success":"btn-outline-success text-light"}`,onClick:()=>U(u==="employee"?null:"employee"),children:"Simulate Employee"}),e.jsx("button",{className:`btn btn-sm ${u==="denied"?"btn-danger":"btn-outline-danger text-light"}`,onClick:()=>U(u==="denied"?null:"denied"),children:"Simulate Denied"})]}),u&&e.jsx("button",{className:"btn btn-link btn-sm text-muted mt-2 p-0 w-100 text-decoration-none",onClick:()=>U(null),children:"Clear Override"})]}),e.jsx("div",{className:"morgue-sidebar-theme-toggle mt-auto",children:e.jsxs("button",{className:"morgue-theme-btn",onClick:se,title:C?"Switch to light theme":"Switch to dark theme",children:[e.jsx("i",{className:`fas ${C?"fa-sun":"fa-moon"} me-2`}),C?"Light Mode":"Dark Mode"]})})]}),e.jsxs("main",{className:"morgue-main",children:[e.jsx("header",{className:"morgue-header d-flex justify-content-between align-items-center",children:e.jsx("div",{children:e.jsx("h2",{style:{margin:0,fontWeight:700},children:"Active Intake Records"})})}),c&&!J&&e.jsxs("div",{className:"morgue-welcome-banner",children:[e.jsxs("div",{className:"morgue-welcome-content",children:[e.jsx("div",{className:"morgue-welcome-icon",children:e.jsx("i",{className:"fas fa-microscope"})}),e.jsxs("div",{className:"morgue-welcome-text",children:[e.jsx("strong",{children:"Welcome to the Morgue Intake System."})," Records are updated daily. If something is missing, use the ",e.jsx("strong",{children:"Request Update"})," button to notify staff."]})]}),e.jsx("button",{className:"morgue-welcome-close",onClick:()=>{localStorage.setItem("morgue_welcome_dismissed","true"),X(!0)},title:"Dismiss",children:e.jsx("i",{className:"fas fa-times"})})]}),$&&e.jsxs("div",{className:"morgue-diagnostics-panel p-3 border-bottom bg-info bg-opacity-10",children:[e.jsxs("div",{className:"d-flex justify-content-between align-items-start mb-2",children:[e.jsxs("h6",{className:"mb-0 text-info fw-bold",children:[e.jsx("i",{className:"fas fa-microscope me-2"}),"Access Diagnostics"]}),e.jsx("button",{className:"btn-close btn-close-sm",onClick:()=>_(!1)})]}),e.jsxs("div",{className:"row g-3",children:[e.jsx("div",{className:"col-md-3",children:e.jsxs("div",{className:"diag-item",children:[e.jsx("label",{children:"Authentication"}),e.jsx("div",{className:i?"text-success":"text-danger",children:i?"AUTHENTICATED":"NOT AUTHENTICATED"}),e.jsx("small",{className:"text-muted",children:t?.username||"No Username"})]})}),e.jsx("div",{className:"col-md-3",children:e.jsxs("div",{className:"diag-item",children:[e.jsx("label",{children:"Access Status"}),e.jsx("div",{className:c?"text-success":"text-danger",children:c?"GRANTED":"DENIED"}),e.jsxs("div",{className:"diag-tags mt-1",children:[h&&e.jsx("span",{className:"badge bg-primary me-1",children:"PHMC"}),m&&e.jsx("span",{className:"badge bg-warning text-dark me-1",children:"Local"})]})]})}),e.jsx("div",{className:"col-md-3",children:e.jsxs("div",{className:"diag-item",children:[e.jsx("label",{children:"Resolved Identity"}),e.jsx("div",{className:"text-truncate",title:p?.name,children:p?.name||"Unknown"}),e.jsxs("small",{className:"font-monospace text-muted",style:{fontSize:"0.7rem"},children:["ID: ",t?.faction?.characterId||t?.activeCharacter?.characterId||"None"]})]})}),e.jsx("div",{className:"col-md-3",children:e.jsxs("div",{className:"diag-item",children:[e.jsx("label",{children:"Database State"}),e.jsxs("div",{children:["Records: ",n?.length||0]}),e.jsxs("small",{className:"text-muted",children:["Filtered: ",S.length]})]})})]})]}),e.jsx("div",{className:"morgue-table-container",children:o?e.jsxs("div",{className:"text-center p-5",children:[e.jsx("i",{className:"fas fa-circle-notch fa-spin fa-3x mb-3 text-primary"}),e.jsx("p",{className:"text-muted",children:"Synchronizing with Morgue Database..."})]}):c?e.jsxs(e.Fragment,{children:[e.jsxs("table",{className:"morgue-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Case #"}),e.jsx("th",{children:"Name"}),e.jsx("th",{children:"Time of Death"}),e.jsx("th",{children:"Location"}),e.jsx("th",{children:"Action"})]})}),e.jsx("tbody",{children:B.length>0?B.map(a=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("span",{className:"badge bg-secondary opacity-75",children:a.caseId})}),e.jsx("td",{children:e.jsx("strong",{children:a.name})}),e.jsx("td",{children:a.timeOfDeath}),e.jsx("td",{children:e.jsx("span",{className:"small",children:a.location})}),e.jsx("td",{children:e.jsx("div",{className:"d-flex flex-column gap-1",children:e.jsx("button",{className:"morgue-btn-view",onClick:()=>ae(a),children:"View Morgue Data"})})})]},a.firebaseKey)):e.jsx("tr",{children:e.jsxs("td",{colSpan:"5",children:[e.jsxs("div",{className:"text-center p-5 morgue-text-muted",children:[e.jsx("i",{className:"fas fa-search fa-2x mb-3 opacity-25"}),e.jsx("p",{className:"mb-1",children:"No records found matching your search."}),e.jsx("p",{className:"small mb-3 opacity-75",children:"Records are synced once daily. If the decedent or case you're looking for is recent, it may not have been imported yet."}),e.jsxs("button",{className:"morgue-btn-request-update mx-auto d-inline-flex",onClick:te,children:[e.jsx("i",{className:"fas fa-paper-plane me-1"}),"Request Update"]})]}),e.jsx("div",{className:"mx-auto mb-4 p-3 rounded bg-warning bg-opacity-10 border border-warning border-opacity-25",style:{maxWidth:"500px"},children:e.jsxs("div",{className:"d-flex align-items-start gap-2",children:[e.jsx("i",{className:"fas fa-lightbulb text-warning mt-1"}),e.jsxs("div",{className:"small morgue-text-muted",children:[e.jsx("strong",{className:"text-warning",children:"Tip:"})," Try searching by the decedent's full name, case number, or location. If you're sure the record exists in the Morgue Database, use the ",e.jsx("strong",{children:"Request Update"})," button above to notify staff or ask Fr0styDev on Discord for a specific entry."]})]})})]})})})]}),P>1&&e.jsxs("div",{className:"morgue-pagination d-flex justify-content-center align-items-center p-4",children:[e.jsx("button",{className:"morgue-page-btn",onClick:()=>K(j-1),disabled:j===1,children:e.jsx("i",{className:"fas fa-chevron-left"})}),e.jsxs("div",{className:"mx-3",children:["Page ",e.jsx("span",{className:"fw-bold",children:j})," of ",P]}),e.jsx("button",{className:"morgue-page-btn",onClick:()=>K(j+1),disabled:j===P,children:e.jsx("i",{className:"fas fa-chevron-right"})})]})]}):e.jsxs("div",{className:"text-center p-5 mt-5",children:[e.jsx("div",{className:"access-denied-icon mb-4",children:e.jsx("i",{className:"fas fa-lock fa-4x text-danger opacity-50"})}),e.jsx("h3",{className:"fw-bold",children:"Access Restricted"}),e.jsx("p",{className:"text-muted mx-auto",style:{maxWidth:"500px"},children:"The Morgue Intake Database contains sensitive information. Access is restricted to authenticated PHMC Employees and authorized Law Enforcement personnel."}),!i&&e.jsx("div",{className:"mt-4 mx-auto",style:{maxWidth:"400px"},children:e.jsx(ue,{showNotification:f,context:"Morgue Lookup"})})]})}),e.jsxs("footer",{className:"morgue-footer",children:[e.jsxs("div",{className:"me-auto small  opacity-75 d-flex align-items-center",children:[e.jsx("i",{className:"fas fa-info-circle me-2"}),"Any issues with accessing, please contact Fr0styDev (Alyson Frost) in the PHMC Discord."]}),L&&e.jsxs("div",{className:`morgue-status-badge ${L.isOverdue?"overdue":""}`,title:"Manual update process (24h cycle)",children:[e.jsx("i",{className:"fas fa-sync-alt fa-spin-hover me-2"}),e.jsx("span",{className:"label",children:"UPDATED:"}),e.jsx("span",{className:"time",children:L.last}),e.jsx("span",{className:"divider mx-2",children:"|"}),e.jsx("span",{className:"label",children:"NEXT:"}),e.jsx("span",{className:"time",children:L.next})]})]})]}),e.jsx(he,{show:V,onClose:()=>F(!1),record:Y,darkMode:C}),e.jsx("style",{children:`
